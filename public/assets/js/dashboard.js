(function ($) {
    ...
    $(function () {
        ...
        //Sessions by Channel doughnut cachart
        ...
        // Pro Banner Logic (safe version)
        if (typeof $.cookie === 'function') {
            var $navbar = $('.navbar');
            var $wrapper = $('.page-body-wrapper');
            var $proBanner = $('#proBanner');
            var $bannerClose = $('#bannerClose');

            if ($proBanner.length && $navbar.length && $wrapper.length) {

                if ($.cookie('stellar-pro-banner') !== "true") {
                    $proBanner.addClass('d-flex').removeClass('d-none');
                ...
                if ($navbar.hasClass("fixed-top")) {
                    ...
                    $navbar.removeClass('proBanner-padding-top');
                } else {
                    $wrapper.addClass('pt-0');
                    $navbar.addClass('proBanner-padding-top');
                }

                $bannerClose.on('click', function () {
                    $proBanner.addClass('d-none').removeClass('d-flex');
                    $navbar.removeClass('pt-5 pt-3 proBanner-padding-top').addClass('fixed-top');
                    $wrapper.addClass('proBanner-padding-top');
