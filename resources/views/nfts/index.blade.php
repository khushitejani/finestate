                    ...
                    <div class="card-body">
                        <div class="d-sm-flex align-items-center mb-4">
                            ...
                            <div class="ms-auto d-flex align-items-center">
                                <a href="{{ route('nfts.create') }}" class="btn btn-primary btn-sm me-3 open-card-modal"
                                    data-title="Create New NFT">
                                    <i class="icon-plus"></i> Create New NFT
                                </a>
                                <a class="btn btn-success btn-sm open-import-modal" data-title="NFT Bulk Import"
                                    data-form-url="{{ route('bulk.import.form') }}"
                                    data-form-submit="{{ route('nfts.bulk.import') }}"
                                    data-form-demo-download="{{ route('nfts.download.demo') }}">
