  <form method="POST" action="{{ route('constructions.store') }}" enctype="multipart/form-data" id="constructionForm">
      @csrf
      <div class="mb-3">
      ...
      <div class="mb-3">
          ...
          <input type="text" name="metal" id="metal" class="form-control" value="{{ old('metal') }}">
      </div>

      <div class="mb-3">
          <label for="builder_men" class="form-label">Builder Men</label>
          <input type="text" name="builder_men" id="builder_men" class="form-control"
              value="{{ old('builder_men') }}">
      </div>

      <div class="mb-3">
          <label for="wood" class="form-label">Wood</label>
          <input type="text" name="wood" id="wood" class="form-control" value="{{ old('wood') }}">
      </div>

      <div class="mb-3">
          <label for="concrete" class="form-label">Concrete</label>
          <input type="text" name="concrete" id="concrete" class="form-control" value="{{ old('concrete') }}">
      </div>
      ...
      <div class="mb-3">
          ...
          <input type="number" step="0.01" name="total_cost_of_construction" class="form-control"
              value="{{ old('total_cost_of_construction', 0) }}">
      </div>
      ...
      <div class="mb-3">
          ...
          <input type="number" step="0.01" name="total_return_after_completion" class="form-control"
              value="{{ old('total_return_after_completion', 0) }}">
      </div>
      <button type="submit" class="btn btn-primary">Create Construction</button>
  </form>
