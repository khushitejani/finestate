<form action="{{ route('shares.store') }}" method="POST" enctype="multipart/form-data" id="shareForm">
    @csrf
    ...
    <div class="mb-3">
        ...
        <input type="number" name="share_price" step="0.01" class="form-control" value="{{ old('share_price') }}"
            required>
    </div>

    <div class="mb-3">
        <label class="form-label">Dividend</label>
        <input type="number" name="dividend" step="0.01" class="form-control" value="{{ old('dividend') }}"
            required>
    </div>

    <div class="mb-3">
        <label class="form-label">Time Period</label>
        <input type="text" name="time_period" class="form-control" value="{{ old('time_period') }}" required>
    </div>

    <div class="mb-3">
        <label class="form-label">Company Capitalization</label>
        <input type="text" name="capitalization" class="form-control" value="{{ old('capitalization') }}" required>
    </div>

    <div class="mb-3">
        <label class="form-label">Available Shares</label>
        <input type="number" name="available_shares" class="form-control" value="{{ old('available_shares') }}"
            required>
    </div>
    <div class="mb-3">
    ...
    <button type="submit" class="btn btn-success">Save Share</button>
</form>
<style>
    .cropper-crop-box,
    .cropper-view-box {
